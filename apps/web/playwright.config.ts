...
const defaultE2EProcessorComponents = JSON.stringify([
  {
    name: 'processor-build-p1',
    label: 'Creation · phase 1',
    description: 'Grounds audiences, prepares inputs, and starts Mind creation.',
    processors: ['draft-group', 'group-creation'],
  },
  {
    name: 'processor-build-p2',
    label: 'Creation · phase 2',
    description: 'Collects and enriches Minds, processes media, and generates imagery.',
    processors: ['mind-collection', 'spark-profile-image'],
  },
  {
    name: 'processor-interactive',
    label: 'Interactive',
    description: 'Runs user-triggered panel work.',
    processors: ['agent-run'],
  },
  {
    name: 'processor-background',
    label: 'Background',
    description: 'Runs schedules and maintenance.',
    processors: ['flow-schedule-run'],
  },
])
  ...
  webServer: {
    ...
    env: (() => {
      ...
      return {
        ...
        DURABULL_PROCESSOR_COMPONENTS:
          process.env.DURABULL_PROCESSOR_COMPONENTS ?? defaultE2EProcessorComponents,
