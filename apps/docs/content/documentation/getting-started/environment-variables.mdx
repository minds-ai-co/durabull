...
| `DURABULL_PROCESSOR_COMPONENTS` | Optional | JSON array of deployment components with `name`, `label`, `description`, and assigned `processors`; enables component-aware worker topology |
